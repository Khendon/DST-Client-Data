...
{
    /// <summary>
    /// Writes client data file using data passed from viewmodel. Due to the required layout not being "strict" CSV, does not use CsvHelper library.
    /// </summary>
    public class CsvWriter
    {
        ...
        {          
            ...
            TextWriter clientDataFile = new StreamWriter(fileName);
            using (clientDataFile)
            {
